...
extension UITextView : UITextViewDelegate {
    ...
    public func resizePlaceholderLabel() {
        ...
        if let placeholderLabel = self.viewWithTag(100) as? UILabel {
            ...
            placeholderLabel.frame = CGRect(x: labelX, y: labelY, width: (kScreenWidth - (4 * labelX) - 5), height: placeholderLabel.frame.size.height)
        }
    }
    ...
    //MARK: - LINE SPACING IN textview TEXT -
