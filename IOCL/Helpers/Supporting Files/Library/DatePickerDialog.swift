...
open class DatePickerDialog: UIView {
    ...
    @objc public init(
        ...
        self.textColor = textColor ?? .appColor(.themeLight)
        self.buttonColor = buttonColor ?? UIColor.appColor(.themeLight)
        self.font = font
    ...
    private func createContainerView() -> UIView {
        ...
        gradient.colors = PickerColors.gradientBackground
        ...
        container.layer.borderColor = PickerColors.separator.cgColor
        ...
        lineView.backgroundColor = PickerColors.separator
