...
//  static func topViewControllers(_ base: UIViewController? = UIApplication.shared.delegate?.window??.rootViewController) -> UIViewController? {
//        if let nav = base as? UINavigationController {
//            return topViewControllers(nav.visibleViewController)
//        }
//        if let tab = (base as? UITabBarController) , let selected = tab.selectedViewController {
//            return topViewControllers(selected)
//        }
//        if let presented = base?.presentedViewController {
//            return topViewControllers(presented)
//        }
//        return base
//    }
//}
