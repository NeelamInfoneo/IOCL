...
//@available(iOS 14.0, *)
//
//extension CreateLectureVC: UIImagePickerControllerDelegate, UINavigationControllerDelegate{
...
//                    print("Image compressedURL  \(compressedURL)")
//
//                }
//
//            case .failed:
...
//            handler(nil)
//
//            let urlString: String = inputURL.absoluteString
//            print("Image generation urlString \(urlString)")
//            return
//        }
//
...
//@available(iOS 14.0, *)
//@available(iOS 14.0, *)
//extension CreateLectureVC: UIDocumentMenuDelegate, UIDocumentPickerDelegate{
